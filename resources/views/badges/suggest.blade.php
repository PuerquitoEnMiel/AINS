...
@section('header-title', 'Sugerir Nueva Insignia')
@section('header-subtitle', 'Propón una insignia que posees o te gustaría ver en la plataforma')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl p-8">
        <form method="POST" action="{{ route('badge-suggestions.store') }}" class="space-y-6">
            ...
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Nombre de la Insignia</label>
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Ej: Microsoft Certified Educator" 
            ...
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Descripción y Requisitos</label>
                <textarea name="description" rows="4" required placeholder="Explica de qué trata la insignia y qué debe demostrar el docente para conseguirla..." 
            ...
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Enlace Oficial de la Certificación (Opcional)</label>
