...
@section('header-subtitle', 'Conoce a los líderes encargados de guiar la integración pedagógica, ética y técnica de la IA en ANS.')
...
<div class="space-y-12 pb-12 animate-fade-in-up">
    ...
    <div class="bg-gradient-to-r from-ans-dark-green/10 via-ans-light-green/5 to-transparent border border-ans-dark-green/10 rounded-3xl p-8 relative overflow-hidden shadow-sm">
        ...
        <div class="max-w-3xl space-y-3 relative z-10">
            <h3 class="text-xl font-heading font-extrabold text-ans-dark-green">Nuestra Misión</h3>
            <p class="text-sm text-gray-700 leading-relaxed">
                El <strong>AI Task Force</strong> de la American Nicaraguan School (ANS) es un equipo interdisciplinario conformado por educadores, especialistas en tecnología y líderes académicos. Nuestra misión es investigar, validar y proponer lineamientos que permitan el uso constructivo de la Inteligencia Artificial en las aulas, protegiendo la integridad intelectual y la privacidad de nuestra comunidad.
            </p>
        </div>
    </div>
    ...
    <div class="space-y-6">
        <div class="border-b border-gray-200 pb-4">
            ...
            <p class="text-gray-500 mt-1">Líderes de proyecto a los que puedes contactar para resolver dudas o proponer iniciativas.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div class="lg:col-span-4 bg-ans-dark-green text-white rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden shadow-md">
            ...
            <div class="space-y-6 relative z-10">
                <h4 class="text-2xl font-heading font-extrabold tracking-tight">¿Tienes dudas o propuestas?</h4>
                <p class="text-sm text-white/80 leading-relaxed">
                    Escríbenos directamente a través de este canal institucional. Evaluamos cada sugerencia sobre el catálogo de herramientas de IA o las directrices de integridad académica de la institución.
                </p>
            </div>
            ...
            <div class="space-y-4 pt-8 relative z-10 border-t border-white/10 text-xs">
                <div class="flex items-center gap-3">
                    ...
                    <span>Edificio de Innovación, Aula 102</span>
                </div>
                <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-lg">⏰</span>
                    <span>Lunes a Viernes: 8:00 AM - 3:00 PM</span>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-8 bg-white border border-gray-200/60 rounded-3xl p-8 shadow-sm relative">
            ...
            <div id="contact-success-toast" class="hidden absolute inset-0 bg-white rounded-3xl z-10 flex flex-col items-center justify-center text-center p-8 space-y-4 animate-fade-in-up">
                <div class="w-16 h-16 bg-emerald-100 text-emerald-800 rounded-full flex items-center justify-center text-3xl">
                    ✓
                </div>
                <div>
                    <h5 class="text-xl font-heading font-extrabold text-gray-900">¡Mensaje Enviado Exitosamente!</h5>
                    <p class="text-sm text-gray-500 mt-2 max-w-sm">Tu duda o propuesta ha sido recibida de forma exitosa por el AI Task Force de ANS. Te responderemos en un plazo máximo de 48 horas hábiles.</p>
                </div>
            ...
            <form id="task-force-contact-form" onsubmit="submitContactForm(event)" class="space-y-6">
                <h4 class="text-xl font-heading font-extrabold text-gray-800">Enviar sugerencia o consulta</h4>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="name" class="text-xs font-bold text-gray-500 uppercase tracking-wider">Nombre Completo</label>
                    ...
                    <div class="space-y-2">
                        <label for="email" class="text-xs font-bold text-gray-500 uppercase tracking-wider">Correo Institucional</label>
                ...
                <div class="space-y-2">
                    <label for="subject" class="text-xs font-bold text-gray-500 uppercase tracking-wider">Asunto</label>
                ...
                <div class="space-y-2">
                    <label for="message" class="text-xs font-bold text-gray-500 uppercase tracking-wider">Mensaje o Propuesta</label>
