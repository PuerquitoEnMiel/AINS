    ...
    <div id="sidebar-inner" class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 mt-6 overflow-y-auto space-y-6">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('resources.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ request()->routeIs('resources.*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-light-green' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    <span class="whitespace-nowrap">Learning Hub</span>
                </a>
                @auth
                @if(Auth::user()->isTeacher() || Auth::user()->isAdmin())
                ...
                <a href="{{ route('badge-suggestions.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ request()->routeIs('badge-suggestions.index') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-light-green' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                    <span class="whitespace-nowrap">Badge Suggestions</span>
                </a>
                @endif
                @endauth
                @auth
            ...
            @php
                $unreadNotificationsCount = \App\Models\AdminNotification::whereNull('read_at')->count();
            @endphp
            <div class="pt-4 border-t border-white/10 space-y-1">
                ...
                <a href="{{ route('admin.resources.index') }}" class="flex items-center justify-between px-4 py-2.5 rounded-xl {{ request()->is('admin/resources*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        <span class="whitespace-nowrap">Learning Hub</span>
                    </div>
                    @php $pendingRes = \App\Models\Resource::where('is_published', false)->count(); @endphp
                    @if($pendingRes > 0)
                        <span class="px-2 py-0.5 text-[10px] font-bold bg-ans-orange text-white rounded-full">{{ $pendingRes }}</span>
                    @endif
                </a>
                ...
                <a href="{{ route('admin.badge-suggestions.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ request()->routeIs('admin.badge-suggestions.index') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                    <span class="whitespace-nowrap">Badge Suggestions</span>
                </a>
                ...
                <a href="{{ route('admin.notifications.index') }}" class="flex items-center justify-between px-4 py-2.5 rounded-xl {{ request()->is('admin/notifications*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                        <span class="whitespace-nowrap">Telemetry Alerts</span>
                    </div>
                    @if($unreadNotificationsCount > 0)
                        <span class="px-2 py-0.5 text-[10px] font-bold bg-red-500 text-white rounded-full animate-pulse">{{ $unreadNotificationsCount }}</span>
                    @endif
                </a>
                <a href="{{ route('admin.notification-templates.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl {{ request()->is('admin/notification-templates*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    <span class="whitespace-nowrap">Email Templates</span>
                </a>
            </div>
            @endif
            @endauth
    ...
    <div class="absolute left-0 top-0 bottom-0 w-72 bg-gradient-to-b from-ans-dark-green to-ans-seal-green text-white flex flex-col shadow-2xl transform -translate-x-full transition-transform duration-300" id="mobile-drawer-panel">
        ...
        <nav class="flex-1 px-4 mt-4 overflow-y-auto space-y-5">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('resources.index') }}" class="flex items-center gap-3 px-4 py-2 rounded-xl {{ request()->routeIs('resources.*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-light-green' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
            ...
            <div class="pt-3 border-t border-white/10 space-y-1">
                ...
                <a href="{{ route('admin.resources.index') }}" class="flex items-center justify-between px-4 py-2 rounded-xl {{ request()->is('admin/resources*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        <span class="text-sm">Learning Hub</span>
                    </div>
                ...
                <a href="{{ route('admin.notifications.index') }}" class="flex items-center justify-between px-4 py-2 rounded-xl {{ request()->is('admin/notifications*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                        <span class="text-sm">Telemetry Alerts</span>
                    </div>
                    @if($unreadNotificationsCount > 0)
                        <span class="px-2 py-0.5 text-[10px] font-bold bg-red-500 text-white rounded-full animate-pulse">{{ $unreadNotificationsCount }}</span>
                    @endif
                </a>
                <a href="{{ route('admin.notification-templates.index') }}" class="flex items-center gap-3 px-4 py-2 rounded-xl {{ request()->is('admin/notification-templates*') ? 'bg-white/10 text-white font-medium border-l-4 border-ans-orange shadow-inner' : 'hover:bg-white/5 text-gray-300 hover:text-white border-l-4 border-transparent hover:border-ans-orange' }} transition-all">
                    <svg class="w-5 h-5 opacity-70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
...
<div class="flex-1 flex flex-col h-screen overflow-hidden bg-gray-50/50 relative">
    ...
    <!-- Content -->
    <main id="main-workspace-content" class="flex-1 overflow-y-auto p-8 z-10 scroll-smooth opacity-0">
