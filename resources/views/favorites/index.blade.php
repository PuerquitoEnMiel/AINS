...
<div class="flex flex-col items-center justify-center py-24 text-center bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
    ...
    <h3 class="text-2xl font-heading font-extrabold text-gray-800 mb-3">Aún no tienes herramientas favoritas</h3>
    <p class="text-gray-500 mb-8 max-w-md text-sm leading-relaxed">Explora nuestro catálogo curado y haz clic en el ícono del corazón de cualquier herramienta de Inteligencia Artificial para guardarla en esta sección.</p>
