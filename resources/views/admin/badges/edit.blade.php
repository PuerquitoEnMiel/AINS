            ...
            <div class="border border-amber-200 bg-amber-50 rounded-2xl p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex gap-3 items-center">
                            <input type="number" name="validity_days" id="validity_days" value="{{ old('validity_days', $badge->validity_days) }}" placeholder="e.g. 1095" min="1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-amber-300 focus:border-amber-400 outline-none transition-all">
