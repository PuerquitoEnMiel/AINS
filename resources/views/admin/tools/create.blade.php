@extends('layouts.app')
@section('header-title') Add New Tool @endsection
@section('header-subtitle') Create a new tool entry for the public catalog. @endsection
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form method="POST" action="{{ route('admin.tools.store') }}" enctype="multipart/form-data" 
            ...
            <div class="bg-gradient-to-r from-ans-blue/5 to-white px-8 py-5 border-b border-gray-100">
                <h2 class="text-xl font-heading font-bold text-gray-900">New Tool</h2>
                <p class="text-sm text-gray-500 mt-1">Fill in all details for the new catalog entry.</p>
            </div>
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <div id="drop-zone" class="flex flex-col sm:flex-row items-center gap-5 p-5 border-2 border-dashed border-gray-200 hover:border-ans-dark-green/40 hover:bg-ans-dark-green/5 rounded-2xl transition-all duration-300 cursor-pointer">
                        <div id="logo-preview" class="w-20 h-20 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-400 overflow-hidden flex-shrink-0 border border-gray-100 bg-white shadow-sm group-hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="text-center sm:text-left flex-1">
                            ...
                            <p class="text-xs text-gray-400 mt-2">PNG, JPG up to 2MB. Drag & drop image here.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-8 py-6 bg-gradient-to-r from-gray-50 to-white border-t border-gray-100 flex gap-3">
                <button type="submit" class="flex-1 bg-gradient-to-r from-ans-blue to-ans-light-blue hover:from-ans-light-blue hover:to-ans-blue text-white font-bold py-3.5 rounded-xl shadow-lg shadow-ans-blue/20 hover:shadow-xl transition-all text-sm flex items-center justify-center gap-2">
