            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="input-desc" name="description" required rows="3"
                        class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ans-light-green/20 focus:border-ans-light-green focus:bg-white transition-all resize-none">{{ old('description', $tool->description) }}</textarea>
                </div>
