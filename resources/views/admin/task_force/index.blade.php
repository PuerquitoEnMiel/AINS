...
<div class="flex items-center justify-between mb-6">
    <h3 class="text-lg font-heading font-bold text-gray-800">Committee Members</h3>
    <a href="{{ route('admin.task-force.create') }}" class="px-5 py-2.5 bg-ans-dark-green text-white rounded-xl font-semibold text-sm hover:bg-ans-seal-green transition-all shadow-md">+ New Member</a>
</div>
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.task-force.edit', $member) }}" class="px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg text-xs font-semibold hover:bg-blue-100 transition-colors">Edit</a>
                        <form method="POST" action="{{ route('admin.task-force.destroy', $member) }}" onsubmit="return confirm('Delete this member?')">
                            @csrf @method('DELETE')
