...
{
    public function generate(Tool $tool, GeminiService $geminiService)
    {
        ...
        $prompt = "Analyze the following teacher reviews for the educational tool: '{$tool->name}' (Description: {$tool->description}).\n\n" .
                  "Reviews:\n" .
                  $reviewsText . "\n\n" .
                  "Generate a summary and pedagogical insights. Your response MUST be a valid JSON object matching this schema exactly:\n" .
                  "{\n" .
                  ...
                  "}\n\n" .
                  "Note: translate the fields to English as requested.";

        try {
            $rawText = $geminiService->generate(
                [['text' => $prompt]],
                null,
